...
* [K155RE3.bin](/K155PE3.bin) -- прошивка для ПЗУ D10. [K155RE3n.bin](/K155PE3n.bin) -- та же прошивка, но без торможения работы процессора при выводе бордюра и КСИ/ССИ.
