...
* [K155RE3.bin](/K155PE3.bin) -- прошивка для ПЗУ D10 без торможения работы процессора при выводе бордюра и КСИ/ССИ. [K155RE3n.bin](/K155PE3n.bin) -- та же прошивка, но в "стандартном" режиме работы процессора.
