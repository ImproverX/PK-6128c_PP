...
* [K155RE3.bin](/K155PE3.bin) -- прошивка для ПЗУ D10 с кратностью "2 такта" торможения работы процессора при выводе бордюра и КСИ/ССИ (рекомендуется). На случай глюков в некоторых программах сделал [K155RE3n.bin](/K155PE3n.bin) -- та же прошивка, но со "стандартным" режимом работы процессора.
