...
Нумерация элементов оригинального ПК-6128ц по возможности сохранена, добавленные микросхемы обозначены U**, резисторы R200 и далее, конденсаторы C100 и далее.
