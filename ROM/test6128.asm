...
;
	.db  "Improver"
	RET		; для RST7
	.db  "TEST6128+00"	; метка версии прошивки
;
L_TROM:	MOV  A, M
	XRA  D
	MOV  D, A
...
;	JMP	L_STL
;
; копируем дописанную программу в память с адреса 0100h, с проверкой
	...
	JMP     L_CP
;
L_KUS:	LXI  B, (LnPRG2+1)/2	; счётчик
